...
{
    echo $ten = $sanpham->find('h3', 0)->innertext . '<br>';
    echo $anh = $sanpham->find('img', 0) . '<br>';
    echo $gia = $sanpham->find('strong ', 0)->innertext . '<br>';
    echo $khuyenmai = $sanpham->find('div span', 0)->innertext . '<br>';
...
{
    echo $ten = $sanpham->find('h3', 0)->innertext . '<br>';
    echo $anh = $sanpham->find('img', 0)->innertext . '<br>';
